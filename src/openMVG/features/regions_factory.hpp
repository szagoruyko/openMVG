...
typedef Scalar_Regions<SIOPointFeature,float,512> DeepCompare_Regions;
...
CEREAL_REGISTER_TYPE_WITH_NAME(openMVG::features::DeepCompare_Regions, "DeepCompare_Regions");
